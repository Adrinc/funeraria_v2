...
const technologies = [
/*   { name: 'aaaaaa', logo: './favicon.png' },
  { name: 'ssss', logo: './favicon.png' },
  { name: 'wwww', logo: './favicon.png' },
  { name: 'eeeee', logo: './favicon.png' },
  { name: 'rrrrr', logo: './favicon.png' },
  { name: 'ttttt', logo: './favicon.png' },
  { name: 'asdaauuusdasd', logo: './favicon.png' },
  { name: 'gggfgf', logo: './favicon.png' }, */
